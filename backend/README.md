...
## Project Structure
    ...
    ├── kingdom_wealth_inst_35380  # Django project configurations
...
1. Clone this repo and `cd kingdom_wealth_inst_35380`
...
2. Clone this repo and `cd kingdom_wealth_inst_35380`
